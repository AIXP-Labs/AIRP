> **Source of truth:** This document is mirrored for the documentation site. The authoritative version lives in [`/adrs/adr-006-prc-jurisdiction.md`](https://github.com/AIXP-Labs/AIRP/blob/main/adrs/adr-006-prc-jurisdiction.md). Edits MUST go to the authoritative file first.
