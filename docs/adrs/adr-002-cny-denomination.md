> **Source of truth:** This document is mirrored for the documentation site. The authoritative version lives in [`/adrs/adr-002-cny-denomination.md`](https://github.com/AIXP-Labs/AIRP/blob/main/adrs/adr-002-cny-denomination.md). Edits MUST go to the authoritative file first.
