> **Source of truth:** This document is mirrored for the documentation site. The authoritative version lives in [`/adrs/adr-009-relationship-with-actp-apop.md`](https://github.com/AIXP-Labs/AIRP/blob/main/adrs/adr-009-relationship-with-actp-apop.md). Edits MUST go to the authoritative file first.
